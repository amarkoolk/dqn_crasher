...
if __name__ == "__main__":
    ...
    original_ego = DQN_Agent(env, args, device, save_trajectories=args.save_trajectories, multi_agent=True, trajectory_path=trajectory_path, ego_or_npc='EGO', override_obs=10)
    ...
    npc_vs_ego(env, original_ego, npc_agent, args, device, ego_version, npc_version, npc_model)
    ...
    ego_vs_npc(env, original_ego, npc_agent, args, device, ego_version, npc_version, ego_model)
    agent_eval(env, original_ego, npc_agent, args, device, ego_version, npc_version)
    env.close()