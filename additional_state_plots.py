...
if __name__ == "__main__":
    ...
    state11_mobil_speed_df_fb = pd.DataFrame(run_history["3124"], columns=["_step", "rollout/model_0_speed", "rollout/spawn_config"])
    state11_npc_speed_df_fb = pd.DataFrame(run_history["3124"], columns=["_step", "rollout/model_1_speed", "rollout/spawn_config"])
    state11_mobil_sr_df_fb = pd.DataFrame(run_history["3124"], columns=["_step", "rollout/model_0_sr100", "rollout/spawn_config"])
    state11_npc_sr_df_fb = pd.DataFrame(run_history["3124"], columns=["_step", "rollout/model_1_sr100", "rollout/spawn_config"])
    ...
    fb_npc_pivoted = state11_npc_speed_df_fb.pivot(index='_step', columns='rollout/spawn_config', values='rollout/model_1_speed')
