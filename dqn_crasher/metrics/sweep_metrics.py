...
scenarios = [
    'MobilPolicy.forward_right', 'MobilPolicy.forward_left', 'MobilPolicy.behind_right',
    'MobilPolicy.behind_left', 'IdleSlower', 'IdleFaster', 'CutIn', 'CutInSlowDown'
]
...
for metric in metrics:
    for scenario in scenarios:
        data.append({
            ...
            'Best Value': best_run_reward.summary.get(f"{prefix}/{scenario}/{metric}", 0),
